...
namespace BookingApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Search(string city, string arrivalDate, string departureDate, string type, string landlord = "")
        {
            HttpClient client = new();

            string path = this.Request.Scheme + "://" + this.Request.Host.Value + "/api/advancedsearch/" + city + "/" + arrivalDate + "/" + departureDate + "/" + type + "/" + landlord;
