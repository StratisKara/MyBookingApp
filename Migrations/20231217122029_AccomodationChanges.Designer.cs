...
namespace BookingApp.Migrations
{
    ...
    [Migration("20231217122029_AccomodationChanges")]
    partial class AccomodationChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingApp.Models.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookingApp.Models.Transaction", b =>
                {
                    b.HasOne("BookingApp.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("BookingApp.Models.User", "Sender")
                        .WithMany()
